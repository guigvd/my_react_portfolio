      ...
      <div className="basis-3/5 z-10 mt-16 md:mt-32 flex justify-center md:order-2">
        {isAboveLarge ? (
          ...
          >
            <img
              alt="profile"
              className="hover:filter hover:saturate-200 transition duration-500 z-10 w-full max-w-[400px] md:max-w-[520px]"
              src={profilePic}
            />
          </div>
        ) : (
      ...
      <div className="z-30 basis-2/5 mt-12 md:mt-32">
        ...
        >
          <p className="text-5xl font-playfair z-10 text-center md:text-start">
            Guilherme {""}
            <span className="xs:relative xs:text-deep-pink xs:font-semibold z-[20] xs:before:content-brush before:absolute before:-left-[20px] before:-top-[75px] before:z-[-10] before:max-w-[20px]">
              Veloso
            </span>
          </p>
        ...
        >
          ...
          <AnchorLink
            ...
            href="#contact"
          >
            <div className="bg-deep-pink hover:text-yellow transition duration-500 w-full h-full flex items-center justify-center px-10 font-playfair">
              Let's Talk
            </div>
          </AnchorLink>
        </motion.div>
